...
#include "panda_sim/VacuumGripperControl.h"
#include "panda_sim/VacuumGripperState.h"
    ...
    sdf::ElementPtr _sdf)
{
  ...
  this->dataPtr->statePub = this->dataPtr->rosnode->advertise<
    panda_sim::VacuumGripperState>(stateTopic, 1000);
}
...
bool ROSVacuumGripperPlugin::OnGripperControl(
  panda_sim::VacuumGripperControl::Request &_req,
  panda_sim::VacuumGripperControl::Response &_res)
{
...
{
  panda_sim::VacuumGripperState msg;
