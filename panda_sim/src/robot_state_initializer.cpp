...
int main(int argc, char **argv) {
  ...
  std::string panda_arm_controller{"panda_arm_controller"}, joint_position_controller{"joint_position_controller"};
  std::vector<std::string> stop_controllers{panda_arm_controller};
